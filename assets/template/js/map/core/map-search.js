                ...
                var position = new google.maps.LatLng(listing.lat, listing.lng),
                    ...
                    */
					marker = new google.maps.Marker({
                        ...
                        draggable: false,
                        content: listing.name.toString(),
                        picture: 'http://directory.chimpgroup.com/wp-content/uploads/services-dir05-370x280.jpg',
                        icon: markerIcons[Math.floor(Math.random()* markerIcons.length)],
                        featured: true,
                        date: '2015-01-05',
                ...
                google.maps.event.addListener(marker, 'click', (function(marker, i) {
                      return function() {
                          ...
                          if( typeof marker.picture !== "object") {
                              var tooltip_picture = "<figure><a href="+marker.url+">"+featuredlabel+"<img src="+marker.picture+" alt='' /></a></figure>";
                          } else {
                              var tooltip_picture = "";
                          }
                          var html = "<div class='location-tooltip'><div class='loc-info'>"
                                    ...
                                    +"<h2><a href="+marker.url+">"+marker.content+"</a></h2>"
...
!(function () {
    ...
    FindMe = flight.component(function () {
        ...
        this.initializeAutoComplete = function() {
            var component                  = this;
            component.autoCompleteTarget = $(this.$node.data('bind'));
            autocomplete = new google.maps.places.Autocomplete(component.autoCompleteTarget.get(0), {
                types: ["geocode"]
            });
...
!(function () {
    var MapSearchData = flight.component(function () {
        ...
        this.fetchResults = function (e) {
            ...
            $(".loader").html('<i class="icon-spinner8 icon-spin"></i>');
