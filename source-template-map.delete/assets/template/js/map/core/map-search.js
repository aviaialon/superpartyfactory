...
var Map_Helpers =
{
    lockMap: function (map)
    {
        ...
        Exposed_Globals.set('lockState', 'locked');
    },
    ...
    unlockMap: function (map)
    {
        ...
        Exposed_Globals.set('lockState', 'unlocked');
    },

    toggleMapLock: function (map)
    {
		console.log('toggleMapLock called');
		switch (Exposed_Globals.get('lockState')) {
			case 'unlocked': {
...
!(function () {
    var MapPinPaths = {
        primaryPin: new google.maps.MarkerImage(MarkersImgPath + "markers-pretzel-41cc737abbd3651d4cf8b04bfc8257c2.png", 
			new google.maps.Size(22, 30), new google.maps.Point(0, 0)),
        viewedPrimaryPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(22, 30), new google.maps.Point(0, 40)),
        currentPrimaryPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(22, 30), new google.maps.Point(53, 0)),
        viewedCurrentPrimaryPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(22, 30), new google.maps.Point(53, 0)),
        secondaryPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(11, 11), new google.maps.Point(75, 0)),
        viewedSecondaryPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(11, 11), new google.maps.Point(75, 40)),
        currentSecondaryPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(11, 11), new google.maps.Point(86, 0)),
        viewedCurrentSecondaryPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(11, 11), new google.maps.Point(86, 0)),
        wishListPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(31, 27), new google.maps.Point(22, 0)),
        currentWishListPin: new google.maps.MarkerImage(MarkersImgPath + "/markers-1eedad27879b2e2159046678adb53345.png", 
			new google.maps.Size(31, 27), new google.maps.Point(22, 40)),
        primaryFindMePin: MarkersImgPath +  "/orange-marker.svg",
        primaryClusterPin: MarkersImgPath + "/cluster-m1.png"
    };
...
!(function () {
    var SearchInForm = flight.component(function () {
        ...
        this.after("initialize", function () {
			console.log('---------------------- LOCATION SELECTOR ------------------------- 1042');
			console.log(this.select("locationSelector").get(0));
            var component = this;
            ...
            data.listingData.forEach(function (listing, i) {
                var position = new google.maps.LatLng(listing.lat, listing.lng),
                    ...
                    markerIcons = [
						...
						MarkersImgPath + '/Restaurant.png',
						MarkersImgPath + '/Hotel.png',
						MarkersImgPath + '/Pets.png',
						MarkersImgPath + '/Sale.png',
						MarkersImgPath + '/Jobs.png',
						MarkersImgPath + '/Motors.png',
						MarkersImgPath + '/Property.png'
                    ],
...
*/
            ...
            var clusterStyles = [{
                ...
                url: MapPinPaths.primaryClusterPin,
                height: 80,
                width: 80,
                textSize:12
            }];
...
!(function () {
	var MapPinPaths = require("map_search/MapPinPaths"),
    FindMe = flight.component(function () {
        this.defaultAttrs({
            buttonSelector: ".__location",
            inputSelector: ".map_filter_location"
        });
		
		this.addFindMeMarker = function(lat, lng) {
			/*
			var map = Exposed_Globals.get('currentExposedMap');
			...
			*/
			...
			var map    = Exposed_Globals.get('currentExposedMap'),
				...
				map: map,
				title: 'You are here!',
				icon: new google.maps.MarkerImage(MapPinPaths.primaryFindMePin,
					null, null, null, new google.maps.Size(64,55)),
				shadow: ''
			});
        ...
        this.findLocationByAddress = function (event) {
            ...
            objMapDirectionApi.getAddressGeocode($(event.target).val(), function(data, result) {
                $('#lat').val(data.lat);
                $('#lng').val(data.lng);
				component.addFindMeMarker(data.lat, data.lng);
                target.val(data.fma);
				/* We dont need to trigger the search again, since it will be triggered on map change
        ...
        this.findMyLocation = function (event) {
            ...
            objMapDirectionApi.getGeoLocation(function(objGeoLocation) {
				...
				component.addFindMeMarker(objGeoLocation.coords.latitude, objGeoLocation.coords.longitude);
        ...
        this.after("initialize", function () {
			...
			console.log('RETURN VOID ON KEYPRESS');
