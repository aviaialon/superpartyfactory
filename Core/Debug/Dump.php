 ...
 * Debugging class
 *
 * This class controls the debugging scope
 *
 * @namespace    Core
 * @package      Core
 * @subpackage   Debug
...
class Dump
{
	...
	public static final function getInstance($var, $die=false, $forceType="", $bCollapsed=false)
	{
		return new self($var, $forceType, $bCollapsed, $die);	
	}
	
	//constructor
	function __construct($var, $forceType="", $bCollapsed=false, $die=false) {
		...
		if ((bool) $die) die('Exited by ' . __CLASS__);	
	}
