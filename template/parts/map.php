...
/*
	...
	require_once '/var/www/spf.dns04.com/template/data/listings_data_access.php';
...
//var_dump(unserialize(file_get_contents('http://www.geoplugin.net/php.gp?ip='.$_SERVER['REMOTE_ADDR'])));
...
.map-refresh-controls .btn-primary:hover, .map-refresh-controls .btn-primary:focus {
  border-color: #1689c7;
...
.map-refresh-controls input[type="checkbox"], .multiselect-container input[type="checkbox"]{
...
.multiselect-container input[type="checkbox"]:checked {
	outline: none;
  	border-color: #BFBEBE;
  	box-shadow: inset 0 1px 1px 0 rgba(0,0,0,0.08),0 0 2px 2px #EEE;
}

.map-refresh-controls input[type="radio"]:checked:before, .multiselect-container input[type="radio"]:checked:before {
    content: "";
    position: absolute;
    height: 0.45em;
    width: 0.45em;
...
.map-refresh-controls input[type="checkbox"]:checked, .multiselect-container input[type="checkbox"]:checked {
...
.multiselect-search, .multi-select-single {
  background: url(assets/template/img/filter.png) no-repeat 95%;
...
ul.multiselect-container li.filter-hidden {
...
ul.multiselect-container > li:first-child:before {
...
.multiselect-container .multiselect-all a {
	padding-top: 9px !important;	
}
.directory-advanced-search-content .btn-group,
.directory-advanced-search-content button.multiselect {
	width: 100%;
}
.directory-advanced-search-content button.multiselect {
  color: #949494;
  ...
  height: 40px;
  border-radius: 0px;
  box-shadow: 0px 0px 2px 0px #cdd0d3;
  border: none;
}
</style>
            ...
            <ul>
              ...
              <li>
                ...
                <select multiple="multiple" class="multi-select multi-select-subcat" name="categories[]" style="display:none">
                  ...
                  <option value="17">Bandsaw (meat) </option>
                  <option value="20">Cement Mixer</option>
                  <option value="33">Drywall and Panel Lift</option>
                  <option value="46">Laminate Flooring Cutter</option>
                  <option value="82">Tile Installation Kit</option>
                  <option value="83">Tile Saws</option>
                  <option value="87">Workbench/Scaffold (Folding)</option>
                </select>
                
                <!--<select class="form-select dir-map-search SlectBox" name="type">
...
<script type="text/javascript" src="assets/template/js/jquery/multiselect.js"></script>
