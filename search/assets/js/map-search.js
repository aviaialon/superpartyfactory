...
!(function () {
    ...
    provide("map_search/GoogleMapStyle", GoogleMapStyle)
		...
		/*https://a1.muscache.com/airbnb/static/map_search/markers-1eedad27879b2e2159046678adb53345.png*/
!(function () {
    var MapPinPaths = {
		primaryPin: new google.maps.MarkerImage("assets/images/markers/markers-pretzel-41cc737abbd3651d4cf8b04bfc8257c2.png", new google.maps.Size(22, 30), new google.maps.Point(0, 0)),
        viewedPrimaryPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(22, 30), new google.maps.Point(0, 40)),
        currentPrimaryPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(22, 30), new google.maps.Point(53, 0)),
        viewedCurrentPrimaryPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(22, 30), new google.maps.Point(53, 0)),
        secondaryPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(11, 11), new google.maps.Point(75, 0)),
        viewedSecondaryPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(11, 11), new google.maps.Point(75, 40)),
        currentSecondaryPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(11, 11), new google.maps.Point(86, 0)),
        viewedCurrentSecondaryPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(11, 11), new google.maps.Point(86, 0)),
        wishListPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(31, 27), new google.maps.Point(22, 0)),
        currentWishListPin: new google.maps.MarkerImage("assets/images/markers/markers-1eedad27879b2e2159046678adb53345.png", new google.maps.Size(31, 27), new google.maps.Point(22, 40)),
        primaryPinShadowUrl: "assets/images/markers/marker-shadow-dfebbf0eb3368c537ba4fa5a77830284.png"
    };
        ...
        this.plotResults = function (e, data) {
            ...
            if (data.currentSearch.map.search_by_map) {
                ...
                if (data.listingData.length) {
                    ...
                    geocoder.geocode({
                        address: data.currentSearch.header.location
...
!(function () {
    var Filters = flight.component(function () {
        this.defaultAttrs({
            ...
            nearestListings: ".closest",
            introFilterSelector: ".intro-filter .icon-toggle, .intro-filter .price-range-slider, .intro-filter .checkbox input",
            
            buildingTypeSelector: ".listingsBuildingType"
        });
        this.toggleSelected = function (e, data) {
            $(data.el).toggleClass("selected")
        };
		...
		this.toggleClosestFilters = function (e, data) {
			console.log('test');
            this.triggerFiltersChanged(e, {closest: 1});
        };
		
        this.initPriceSlider = function (options) {
            var $slider = this.select("priceRangeSliderSelector"),
                monthly = options && options.monthly,
                minPriceName = monthly ? "minPriceMonthly" : "minPriceDaily",
                maxPriceName = monthly ? "maxPriceMonthly" : "maxPriceDaily";
        ...
        this.loadBootstrapData = function (e, data) {
            ...
            var currentFilters = data.currentSearch.filters,
                roomTypeGroup, expTypeGroup;
            this.select("tripFormSelector").MlsChineseInputDateSpan({
                onSuccess: this.introFiltersChanged.bind(this),
                onReset: this.introFiltersChanged.bind(this)
            });
            ...
            if (currentFilters.buildingTypeSelector) {
                this.select("buildingTypeSelector").find('[value="' + currentFilters.buildingType + '"]').prop("selected", true)
            }
            
			if (currentFilters.closest) {
				 this.select("nearestListings").prop("checked", "checked");
			}
            ...
            this.select("sizeSelector").each(function (i, elem) {
                var $this = $(this),
                    value = currentFilters[$this.attr("name")];
                if (value) {
                    $this.val(value)
                }
            });
            ...
            var me = this;
            $('select.chosen').chosen({ disable_search_threshold: 5, width: '240px'}).change(function(event) {
            	me.triggerFiltersChanged(event);
			});
			
			$('.closest').change(function(event) {
            	me.triggerFiltersChanged(event);
			});
        ...
        this.updateFilters = function (e, data) {
            var $priceSlider = this.select("priceRangeSliderSelector"),
                newFilters;
        ...
        this.hideEmptyFilters = function () {
            this.select("checkboxGroupSelector").each(function () {
                ...
                if (!$this.find(".checkbox").length) {
                    ...
                    if (!$this.find(".filters-more .checkbox").length) {
        ...
        this.processFilters = function () {
            var filterData = {}, 
            	...
            	buildingType = this.select("buildingTypeSelector").val(),
				closest = this.select("nearestListings").is(':checked');

			if (closest) {
				filterData.closest = true
			}
            ...
            if (buildingType) {
            	filterData.buildingType = buildingType;
            }
            ...
            this.select("sizeSelector").each(function (i, elem) {
                ...
                if (num > 0) {
                    filterData[$this.attr("name")] = num
                }
            });
            if ($activeExpTypes.length) {
                filterData.exp_types = $activeExpTypes.map(function (i, elem) {
                    return $(this).data("name")
                }).get()
            }
            ...
            this.select("checkboxGroupSelector").each(function (i, elem) {
                var $this = $(this),
                    selected = $this.find(":checked").map(function (i, elem) {
                        return $(this).val()
                    }).get();
                if (selected.length) {
                    filterData[$this.data("name")] = selected
                }
            });
            if (keywords) {
        ...
        this.resetFilter = function (e, data) {
            console.log(data.selectedFilter);
        	switch (data.selectedFilter) {
            
			case 'closest':
				console.log('trigger called...');
				closest = this.select("nearestListings").removeAttr('checked');
            ...
            case "room_types":
                ...
                break;
			case "buildingType":
                //this.select("listingsBuildingType").find(this.attr.iconToggleSelector).removeClass("selected");
				buildingTypeSelector = this.select("buildingTypeSelector");
				buildingTypeSelector.find('option:first-child').prop('selected', true).end().trigger('liszt:updated');
                this.triggerFiltersChanged();
                break;	
            case "exp_types":
        ...
        this.isMonthly = function (start, end) {
            ...
            var startDate = $.datepicker.parseDate($.datepicker._defaults.dateFormat, start),
                endDate = $.datepicker.parseDate($.datepicker._defaults.dateFormat, end);
            return ((endDate - startDate) / 86400000) >= 28
        };
        this.scrollView = function (e, data) {
            if (Math.abs(window.orientation) === 90) {
                window.setTimeout(function () {
                    $("body").scrollTop(data.el.offset().top)
                }, 250)
            }
        };
        this.chooseExperienceTypeDisplay = function (e, data) {
            ...
            var market = data.geo && data.geo.market,
                showExpTypes = (market === "Dublin" || market === "London") && this._expTypes;
        ...
        this.after("initialize", function () {
            ...
            this.on("click", {
				...
				nearestListings: this.toggleClosestFilters
            });
...
!(function () {
    var SidebarHeader = flight.component(function () {
        ...
        this.updateAppliedFilters = function (e, data) {
			...
			/*
			console.log('binding');
			$closest = $("a.closest_listings");
			$closest.unbind('click').click(function (event) {
				event.preventDefault();
				console.log('clicked');
				console.log(Exposed_Api.get('Filter'));
				
				Exposed_Api.get('Filter').toggleClosestFilters(event);
			});
			*/
			...
			console.log('binding');
			$('.closest_listings').data('api', this).on('click', function (event) {
				$(this).data('api').toggleClosestFilters(this);
			});
			...
			*/
			...
			$("a.closest_listings").unbind('click').click(function (event) {
				event.preventDefault();
				$('input[type="checkbox"].closest').attr("checked", "checked").trigger('change');
			});
...
!(function () {
    var History = flight.component(function () {
        this.updateLocation = function (e, data) {
            ...
            var paramsForUrl = {}, path = window.location.pathname,
                paramString = "";
            ...
            if (data.currentSearch.source === "page" && data.currentSearch.page > 1) {
                $.extend(paramsForUrl, {
                    page: data.currentSearch.page
                })
            }
            if (paramsForUrl.location) {
                path = this.stripLocationFromPath(path);
                paramString = MlsChinese.SearchUtils.location_to_url_parameter(paramsForUrl.location);
                delete paramsForUrl.location
            }
            if (Object.keys(paramsForUrl).length) {
		if (typeof paramsForUrl.el !== "undefined") {
			delete paramsForUrl.el;
		}

                paramString += "?" + $.param(paramsForUrl, true);
            }
            if (this.hasPushState) {
                this.historyId++;
                window.history.pushState({
                    id: this.historyId
                }, null, path + paramString)
            } else {
...
!(function () {
    var FooterToggle = flight.component(function () {
        this.defaultAttrs({
            footerContainerSelector: ".footer-container"
        });
        this.toggleFooter = function () {
            this.$footer.slideToggle("fast", (function () {
                this.$node.toggleClass("open")
            }).bind(this))
        };
        this.after("initialize", function () {
            this.$footer = $(this.attr.footerContainerSelector);
...
!(function () {
    var FindMe = flight.component(function () {
        ...
        this.after("initialize", function () {
			this.on("click", this.findMyLocation);
        })
    });
...
!(function () {
    var MapSearchData = flight.component(function () {
        this.SEARCH_PARAMS = {
            ...
            header: ["location"],
            filters: ["checkin", "checkout", "exp_types", "empHost", "room_types", "price_min", "price_max", "min_bedrooms", "min_bathrooms", "min_beds", "neighborhoods", "languages", "hosting_amenities", "property_type_id", "connected", "keywords"],
            logging: ["s_tag"],
        ...
        this.mergedParams = function () {
            ...
            }, mapParams, this.currentSearch.header, this.currentSearch.filters, this.currentSearch.logging, this.currentSearch.developer)

	    if (typeof dataReturn.el !== "undefined") {
		delete dataReturn.el;
            }
	   ...
	   this._activeRequest = $.get("api.php", this.mergedParams(), (function (data) {
        ...
        this.fetchResults = function () {
            ...
            this._activeRequest = $.get("api.php", params, (function (data) {
                if (this.currentSearch.source !== "page") {
        ...
        this.dataLoaded = function (eventName, data) {
        	console.log("this.dataLoaded: " + eventName);
        	console.log(data);
...
!(function () {
    var Map = require("map_search/Map"),
        ...
        FooterToggle = require("map_search/FooterToggle"),
