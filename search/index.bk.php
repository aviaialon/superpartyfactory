...
<!DOCTYPE html>
<!--[if lt IE 8]>
<html lang="en-CA" xmlns:fb="http://ogp.me/ns/fb#" class="ie">
<![endif]-->

<!--[if IE 8]>
<html lang="en-CA" xmlns:fb="http://ogp.me/ns/fb#" class="ie ie8">
<![endif]-->

<!--[if IE 9]>
<html lang="en-CA" xmlns:fb="http://ogp.me/ns/fb#" class="ie ie9">
<![endif]-->

<!--[if (gt IE 9)|!(IE)]><!-->
<html lang="en-CA" xmlns:fb="http://ogp.me/ns/fb#">
<!--<![endif]-->
...
<head>
    ...
    <meta charset="utf-8">
    <link href="assets/css/common_o2.1-88e3ea63f9cebc4b82e5ad66c8ec424a.css" media="all" rel="stylesheet" type="text/css" />
    <link href="/static/js/libraries/chosen/chosen.css" media="screen" rel="stylesheet" type="text/css" />
    ...
    <script>
        ...
        var googleMapsUrl = 'http://maps.googleapis.com/maps/api/js?language=en-CA&sensor=false&v=3.13&libraries=places';
    ...
    <title><?php echo $listingData['meta_description']; ?> - <?php echo constant('__SITE_NAME__'); ?></title>
...
<body class=" ">
    <div id="header" class="navbar navbar-top">
        <div class="navbar-inner">
            <div class="container container-full-width page-container"> <a href="/" class="brand airbnb">Airbnb</a>
                <ul class="nav">
        ...
        <div id="footer" class="row">
            ...
            <div class="span3 col-3">
                ...
                <ul class="unstyled list-unstyled js-footer-links">
                    ...
                    <li><a href="http://blog.airbnb.com">Blog</a>
                    </li>
            ...
            <div class="span3 col-3">
                ...
                <ul class="unstyled list-unstyled js-external-links">
                    <li><a href="http://twitter.com/airbnb" target="_blank"> Twitter </a>
                    </li>
                    <li><a href="http://www.facebook.com/airbnb" target="_blank"> Facebook </a>
                    </li>
                    <li><a href="https://plus.google.com/+airbnb" rel="publisher" target="_blank"> Google </a>
                    </li>
                    <li><a href="http://www.youtube.com/airbnb" target="_blank"> YouTube </a>
                    </li>
                </ul>
    ...
    <script src="http://maps.googleapis.com/maps/api/js?language=en-CA&sensor=false&v=3.13&libraries=places"></script>
    <script type="text/javascript" src="/static/js/libraries/chosen/chosen.jquery.min.js"></script>
    ...
    <script>
        ...
        function ___bindQuickView()
        {
            $("a.quick_view").colorbox({
                ...
                'rel': 'listings__qv',
                'transition': 'elastic',
                'current': "<?php echo translate('Listing', 'Propriété', '財產'); ?> {current} / {total}",
                'next': "<?php echo translate('Next', 'Prochain', '下'); ?>",
                'previous': "<?php echo translate('Previous', 'Précédent', '前'); ?>",
                'close': "<?php echo translate('Close', 'Fermer', '關閉')?>"
            });
        }
    </script>
